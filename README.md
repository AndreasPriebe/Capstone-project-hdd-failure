# Capstone Project in Data Science - HDD Failure Prediction
...
For a short introduction to the project, see the stakeholder presentation slides [here](https://github.com/AndreasPriebe/Capstone-project-hdd-failure/reports/to_fail_or_not_to_fail.pdf).
